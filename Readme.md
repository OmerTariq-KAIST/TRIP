...
# Dataset
1. ResTCA is evaluated on four inertial odometry datssets.
...
# Publication
The manuscript "TRIP: Towards Realtime Deep Inertial Odometry for Pose-Invariant Pedestrian Navigation" is currently submitted to IEEE Transaction for possible publication.
